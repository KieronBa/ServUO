    ...
    public class Mining : HarvestSystem
    {
        ...
        private Mining()
        {
            ...
            if (Core.ML)
            {
                ...
                {
                    new BonusHarvestResource(0, 60.0, null, null), //Nothing
                    new BonusHarvestResource(100, 5.0, 1072562, typeof(BlueDiamond)),
                    new BonusHarvestResource(100, 5.0, 1072567, typeof(DarkSapphire)),
                    new BonusHarvestResource(100, 5.0, 1072570, typeof(EcruCitrine)),
                    new BonusHarvestResource(100, 5.0, 1072564, typeof(FireRuby)),
                    new BonusHarvestResource(100, 5.0, 1072566, typeof(PerfectEmerald)),
                    new BonusHarvestResource(100, 5.0, 1072568, typeof(Turquoise)),
                    new BonusHarvestResource(100, 5.0, 1077180, typeof(SmallPieceofBlackrock)),
                    new BonusHarvestResource(100, 5.0, 1113344, typeof(CrystallineBlackrock), Map.TerMur)
				};
            }
