...
namespace Server.Misc
{
    public class SkillCheck
    {
        ...
        public static void Configure()
        {
            ...
            m_StatGainDelay = Config.Get("PlayerCaps.PlayerStatTimeDelay", TimeSpan.FromMinutes(5.0));
            m_PetStatGainDelayEnabled = Config.Get("PlayerCaps.EnablePetStatTimeDelay", false);
            m_PetStatGainDelay = Config.Get("PlayerCaps.PetStatTimeDelay", TimeSpan.FromMinutes(2.0));
        ...
        public static void Gain(Mobile from, Skill skill)
        {
            ...
            {
                int toGain = 1;//int toGain = Utility.RandomMinMax(1, 2);
